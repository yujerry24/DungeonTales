...
public class DungeonTales extends JFrame {
	...
	static class Level extends JPanel {
		...
		public Level(int level, int spawnX, int spawnY, int endX, int endY,
			...
			if (level == 4) {
				...
				platTip.setBounds(SCREEN_WIDTH / 2 - 200, getSpawnY() - 160,
						300, 100);
	...
	public DungeonTales() {
		...
		Timer gravity = new Timer(7, new ActionListener() {
	...
	public static void registerLevels() {
		...
		Rectangle[] tutorialPlats = { new Rectangle(800, SCREEN_HEIGHT - 100,
				100, 20) };

		Level tutorial = new Level(4, 10, SCREEN_HEIGHT - GROUND_WIDTH - 50,
				SCREEN_WIDTH - 400, SCREEN_HEIGHT - GROUND_WIDTH - 100, p,
				tutorialPlats, 1, null);
		tutorial.addKeyListener(kl);
		// Platform tPlat1 = new Platform(800, 500, 800, 800, 90, 30, tutorial,
		// 1, 2);
